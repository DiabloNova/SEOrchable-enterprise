        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 space-y-8 relative z-10 text-center">
          <div className="max-w-3xl mx-auto space-y-3">
            <span className="text-xs uppercase font-black tracking-widest text-[var(--sky-blue-500)]">
              {isFa ? "موتور خزش و بررسی معنایی" : "REAL-TIME SEMANTIC AUDIT INGESTION"}
            </span>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12 relative z-10">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <p className="text-[var(--text-secondary)]">
              {isFa
                ? "با جریان‌های اصلی کار، از بررسی تا پایش و بهینه‌سازی، آشنا شوید. اعداد این بخش صرفاً نمونه‌ای هستند."
                ...
                <div className="space-y-6 animate-fade-in">
                  ...
                  <div className="p-4 rounded-xl bg-white/[0.03] border border-white/5 space-y-3">
                    <div className="flex items-center justify-between text-[10px] text-slate-400">
                      <span>{isFa ? "پرس‌وجو: بهترین ابزار تحلیل برند" : "Query: 'Best brand intelligence platform'"}</span>
